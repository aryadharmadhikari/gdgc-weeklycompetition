...
const Footer = () => {
    ...
    return (
        <footer style={{
            ...
            <div style={{
                padding: isMobile ? gdgTheme.spacing.lg : `${gdgTheme.spacing.xxxl} ${gdgTheme.spacing.xl} ${gdgTheme.spacing.xl}`,
                maxWidth: '1200px',
                margin: '0 auto'
            }}>
                {/* Main Footer Content */}
                <div style={{
                    display: 'grid',
                    // On mobile, this minmax ensures it takes full width and stacks
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: isMobile ? 'center' : 'flex-start' }}>
                        ...
                        <div style={{
                            ...
                            {/* LinkedIn Icon */}
                            <SocialIcon href="https://linkedin.com/company/gdgc-dbit" label="LinkedIn" color="#0077B5">
                                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                            </SocialIcon>

                            {/* YouTube Icon */}
                            <SocialIcon href="https://youtube.com/@gdgcdbit" label="YouTube" color="#FF0000">
                                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
                            </SocialIcon>

                            {/* Instagram Icon */}
                            <SocialIcon href="https://instagram.com/gdgc.dbit" label="Instagram" gradient="radial-gradient(circle at 30% 110%, #ffdb8b 0%, #ee653d 25%, #d42e81 50%, #a237b6 75%, #3e57bc 100%)" borderColor="#d42e81">
...
// Helper Component for Social Icons to reduce duplication
const SocialIcon = ({ href, label, color, gradient, borderColor, children }) => {
    return (
        <a
            href={href}
            target="_blank"
            ...
            onMouseEnter={(e) => {
                if (gradient) e.currentTarget.style.background = gradient;
                else e.currentTarget.style.backgroundColor = color;

                if (borderColor) e.currentTarget.style.borderColor = borderColor;
                else e.currentTarget.style.borderColor = color;
        ...
        >
            <svg width="20" height="20" viewBox="0 0 24 24" fill={gdgTheme.colors.text.primary} style={{ transition: 'fill 0.2s ease' }}>
                {children}
            </svg>
        </a>
    );
