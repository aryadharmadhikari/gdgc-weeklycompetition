                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: isMobile ? 'center' : 'flex-start' }}>
                        ...
                        <div style={{
                            ...
                            {/* Instagram Icon */}
                            <SocialIcon href="https://instagram.com/gdgcdbit" label="Instagram" gradient="radial-gradient(circle at 30% 110%, #ffdb8b 0%, #ee653d 25%, #d42e81 50%, #a237b6 75%, #3e57bc 100%)" borderColor="#d42e81">
